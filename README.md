...
<div align="center" style="margin-bottom: 40px;">
  <p style="font-size: 1.1em; line-height: 1.6;">I build immersive and responsive websites, applications, APIs, and AI models. Specializing in the **MERN Stack, Python, and AI**, I deliver end-to-end solutions that drive real-world impact. Passionate advocate for Women in Tech and open-source contributions.</p>
</div>

---

<h2 align="center" style="color: #FF8C00;">🔥 My GitHub Activity Showcase</h2>

<div align="center" style="width: 95%; margin: 20px auto; border: 1px solid #FF8C00; border-radius: 8px; padding: 15px; background-color: #0d1117; background-image: linear-gradient(0deg, transparent 24%, #262c33 25%, #262c33 26%, transparent 27%, transparent 74%, #262c33 75%, #262c33 76%, transparent 77%, transparent), linear-gradient(90deg, transparent 24%, #262c33 25%, #262c33 26%, transparent 27%, transparent 74%, #262c33 75%, #262c33 76%, transparent 77%, transparent); background-size: 50px 50px;">
  <p style="font-weight: 600; font-size: 1.1em;">🕹️ Pac-Man Contribution Game (Animating My Commitment)</p>
  <picture>
    ...
    <img alt="Pacman contribution graph" src="https://raw.githubusercontent.com/JaimeCabary/JaimeCabary/output/pacman-contribution-graph.svg" width="100%"/>
  </picture>
</div>

<div align="center" style="width: 95%; margin: 30px auto 40px; padding: 20px 10px; border: 1px solid #FF8C00; border-radius: 8px; background-color: #0d1117;">
  <div style="margin-bottom: 20px;">
    <img src="https://visitor-badge.laobi.icu/badge?page_id=JaimeCabary.JaimeCabary&style=for-the-badge&color=orange" alt="Profile views"/>
    <img src="https://github-profile-trophy.vercel.app/?username=JaimeCabary&theme=radical&column=5" alt="GitHub Trophies"/>
  </div>
  
  <img src="https://github-readme-stats.vercel.app/api?username=JaimeCabary&show_icons=true&theme=dark&include_all_commits=true&count_private=true&hide_title=true&hide=prs&border_radius=8&custom_title=GitHub%20Statistics" alt="JaimeCabary GitHub Stats" style="width: 100%; margin-bottom: 15px;"/>
  
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=JaimeCabary&layout=compact&theme=dark&border_radius=8" alt="JaimeCabary Top Languages" style="width: 100%;"/>
</div>

---

<h2 align="center" style="color: #FF8C00;">🚀 My Tech Universe</h2>

<div align="center" style="display: flex; justify-content: center; flex-wrap: wrap; gap: 15px; margin: 25px 0;">
...
<div align="center" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-top: 30px;">
...
<div align="center" style="margin-top: 30px;">
  <a href="https://zeptaherself.netlify.app/#projects" target="_blank">
    <img src="https://img.shields.io/badge/View_All_20+_Projects_on_Portfolio-FF8C00?style=for-the-badge&logo=visualstudio&logoColor=white" alt="Explore All Projects"/>
  </a>
</div>

---

<h2 align="center" style="color: #FF8C00;">⭐ Detailed Skills Matrix</h2>
<p align="center">A comprehensive look at my toolkit, experience depth, and specific use cases.</p>
...
<table width="100%" style="border-collapse: collapse; margin-top: 20px;">
  <thead>
    <tr style="background-color: #FF8C00; color: white;">
      ...
      <th style="padding: 12px; text-align: left;">Proficiency</th>
      <th style="padding: 12px; text-align: left;">Key Use Cases</th>
    </tr>
  </thead>
  <tbody>
    <tr style="border-bottom: 1px solid #30363d;">
      <td rowspan="3" style="padding: 12px;">Backend & AI</td>
      <td style="padding: 12px;">Python</td>
      <td style="padding: 12px;">Expert</td>
      <td style="padding: 12px;">Data Science, Scripting, AI/ML Model Training</td>
    </tr>
    <tr style="border-bottom: 1px solid #30363d;">
      <td style="padding: 12px;">Flask / FastAPI</td>
      <td style="padding: 12px;">Advanced</td>
      <td style="padding: 12px;">Building Scalable RESTful APIs (e.g., Janessa AI backend)</td>
    </tr>
    <tr style="border-bottom: 1px solid #30363d;">
      <td style="padding: 12px;">TensorFlow / ML</td>
      <td style="padding: 12px;">Intermediate</td>
      <td style="padding: 12px;">Building & Deploying AI Models, Data Processing</td>
    </tr>
    <tr style="border-bottom: 1px solid #30363d; background-color: #161b22;">
      <td rowspan="4" style="padding: 12px;">Frontend & Mobile</td>
      <td style="padding: 12px;">JavaScript (ES6+)</td>
      <td style="padding: 12px;">Expert</td>
      <td style="padding: 12px;">Core Web Development, DOM Manipulation, Web3 Integration</td>
    </tr>
    <tr style="border-bottom: 1px solid #30363d; background-color: #161b22;">
      <td style="padding: 12px;">React / Next.js</td>
      <td style="padding: 12px;">Advanced</td>
      <td style="padding: 12px;">Complex UIs, Server-Side Rendering (e.g., UN Revamp)</td>
    </tr>
    <tr style="border-bottom: 1px solid #30363d; background-color: #161b22;">
      <td style="padding: 12px;">Flutter / Dart</td>
      <td style="padding: 12px;">Intermediate</td>
      <td style="padding: 12px;">Cross-Platform Mobile App Development (e.g., Chatsy)</td>
    </tr>
    <tr style="border-bottom: 1px solid #30363d; background-color: #161b22;">
      <td style="padding: 12px;">Tailwind CSS</td>
      <td style="padding: 12px;">Expert</td>
      <td style="padding: 12px;">Utility-First Styling for Rapid, Responsive UI/UX</td>
    </tr>
    <tr style="border-bottom: 1px solid #30363d;">
      <td rowspan="3" style="padding: 12px;">DevOps & Data</td>
      <td style="padding: 12px;">AWS (EC2, S3)</td>
      <td style="padding: 12px;">Intermediate</td>
      <td style="padding: 12px;">Cloud Hosting, Deployment, and Infrastructure Management</td>
    </tr>
    <tr style="border-bottom: 1px solid #30363d;">
      <td style="padding: 12px;">MySQL / SQL</td>
      <td style="padding: 12px;">Advanced</td>
      <td style="padding: 12px;">Database Design, Query Optimization, Data Integrity</td>
    </tr>
    <tr style="border-bottom: 1px solid #30363d;">
      <td style="padding: 12px;">Git / GitHub</td>
      <td style="padding: 12px;">Expert</td>
      <td style="padding: 12px;">Version Control, CI/CD Workflow (GitHub Actions)</td>
    </tr>
  </tbody>
</table>
...
<h2 align="center" style="color: #FF8C00;">📈 Professional Experience Timeline</h2>

<div style="display: flex; justify-content: space-between; gap: 20px; font-size: 1em; margin-bottom: 40px;">
  <div style="flex: 1; min-width: 48%;">
    <h3 style="border-bottom: 2px solid #FF8C00; padding-bottom: 5px; margin-bottom: 20px;">💼 Core Roles</h3>
    <ul style="list-style: none; padding: 0;">
      <li style="margin-bottom: 25px; border-left: 3px solid #FF8C00; padding-left: 15px;">
        <p style="font-weight: 600; margin-bottom: 5px;">CEO, Kabary Software and ZeptaHacker Innovations (2019 - Present)</p>
        <p style="margin: 0; font-size: 0.9em;">Impact: Led the development and deployment of 20+ bespoke software solutions, specializing in AI integration and MERN stack applications. Defined technical strategy and managed client relations.</p>
      </li>
      <li style="margin-bottom: 25px; border-left: 3px solid #FF8C00; padding-left: 15px;">
        <p style="font-weight: 600; margin-bottom: 5px;">Microsoft Learn Student Ambassador (2023 - 2025)</p>
        <p style="margin: 0; font-size: 0.9em;">Focus: Hosted workshops and training sessions on Python, AI, and Cloud Computing (Azure). Mentored 50+ students in digital literacy and community building.</p>
      </li>
      <li style="margin-bottom: 25px; border-left: 3px solid #FF8C00; padding-left: 15px;">
        <p style="font-weight: 600; margin-bottom: 5px;">Student Brand Ambassador, Samsung Mobile (Nov 2024 - Present)</p>
        <p style="margin: 0; font-size: 0.9em;">Activity: Promoted Samsung's mobile technologies and conducted campus tech activations in a hybrid capacity.</p>
      </li>
      <li style="margin-bottom: 25px; border-left: 3px solid #FF8C00; padding-left: 15px;">
        <p style="font-weight: 600; margin-bottom: 5px;">Secretary, IEEE FUTO Student Branch (Feb 2025 - May 2025)</p>
        <p style="margin: 0; font-size: 0.9em;">Role: Organized events, managed communications, and promoted humanitarian technology initiatives. Contributed to Lude Health Centre App (IEEE-sponsored project).</p>
      </li>
    </ul>
  </div>
  <div style="flex: 1; min-width: 48%;">
    <h3 style="border-bottom: 2px solid #FF8C00; padding-bottom: 5px; margin-bottom: 20px;">🎓 Academic & Certifications</h3>
    <ul style="list-style: none; padding: 0;">
      <li style="margin-bottom: 25px; border-left: 3px solid #FF8C00; padding-left: 15px;">
        <p style="font-weight: 600; margin-bottom: 5px;">B.Eng in Software Engineering - FUTO (2021 - Present)</p>
        <p style="margin: 0; font-size: 0.9em;">Focus: Data Structures, Machine Learning, Web Technologies. Actively involved in the Women in Tech advocacy group.</p>
      </li>
      <li style="margin-bottom: 25px; border-left: 3px solid #FF8C00; padding-left: 15px;">
        <p style="font-weight: 600; margin-bottom: 5px;">Complete Python BootCamp (London App Brewery)</p>
        <p style="margin: 0; font-size: 0.9em;">Deep dives into Python, Data Science, and Machine Learning techniques.</p>
      </li>
      <li style="margin-bottom: 25px; border-left: 3px solid #FF8C00; padding-left: 15px;">
        <p style="font-weight: 600; margin-bottom: 5px;">Web Development Course (CSAAE)</p>
        <p style="margin: 0; font-size: 0.9em;">Training in modern web development frameworks and principles.</p>
      </li>
      <li style="margin-bottom: 25px; border-left: 3px solid #FF8C00; padding-left: 15px;">
        <p style="font-weight: 600; margin-bottom: 5px;">Cisco Networking Academy (Python, Get Connected)</p>
        <p style="margin: 0; font-size: 0.9em;">Foundational programming and digital literacy skills.</p>
      </li>
    </ul>
  </div>
</div>
...
<h2 align="center" style="color: #FF8C00;">📜 Literary Works (Authored by Jaime Cabary / Aster L. Lowen)</h2>

<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 20px; margin-top: 20px; margin-bottom: 40px;" align="center">
  <div style="border: 1px solid #FF8C00; border-radius: 8px; padding: 15px;">
    <h4 style="margin-bottom: 5px; color: #FF8C00;">The Billionaire's Son</h4>
    <p style="font-size: 0.9em; margin: 0; color: #aaa;">A captivating story blending wealth, ambition, and personal growth.</p>
  </div>
  <div style="border: 1px solid #FF8C00; border-radius: 8px; padding: 15px;">
    <h4 style="margin-bottom: 5px; color: #FF8C00;">Caught in Between</h4>
    <p style="font-size: 0.9em; margin: 0; color: #aaa;">An engaging narrative exploring complex relationships and choices.</p>
  </div>
  <div style="border: 1px solid #FF8C00; border-radius: 8px; padding: 15px;">
    <h4 style="margin-bottom: 5px; color: #FF8C00;">Twin (as Aster L. Lowen)</h4>
    <p style="font-size: 0.9em; margin: 0; color: #aaa;">Survival, reunion, love and hope in the midst of chaos.</p>
  </div>
  <div style="border: 1px solid #FF8C00; border-radius: 8px; padding: 15px;">
    <h4 style="margin-bottom: 5px; color: #FF8C00;">Moukawlar and Preschool</h4>
    <p style="font-size: 0.9em; margin: 0; color: #aaa;">Drama surrounding a three year old's first day of preschool.</p>
  </div>
</div>

---

<h2 align="center" style="color: #FF8C00;">🎙️ Voice Acting Portfolio</h2>
<p align="center" style="margin-bottom: 30px;">A versatile voice actor specializing in Children's, Teenager, and Young Adult roles, leveraging my background for authentic voice work.</p>

<table width="100%" style="border-collapse: collapse; margin-top: 20px;">
  <thead>
    <tr style="background-color: #FF8C00; color: white;">
      <th style="padding: 10px; text-align: left;">Demo Title</th>
      <th style="padding: 10px; text-align: left;">Category</th>
      <th style="padding: 10px; text-align: left;">Link to Sample (Voices.com)</th>
    </tr>
  </thead>
  <tbody>
    <tr style="border-bottom: 1px solid #30363d;">
      <td style="padding: 10px;">Fee fi for fum</td>
      <td style="padding: 10px;">Audiobooks</td>
      <td style="padding: 10px;"><a href="https://www.voices.com/profile/shalomchidi-azuwike" target="_blank">View Sample</a></td>
    </tr>
    <tr style="border-bottom: 1px solid #30363d; background-color: #161b22;">
      <td style="padding: 10px;">Africa Narration</td>
      <td style="padding: 10px;">Video Narration</td>
      <td style="padding: 10px;"><a href="https://www.voices.com/profile/shalomchidi-azuwike" target="_blank">View Sample</a></td>
    </tr>
    <tr style="border-bottom: 1px solid #30363d;">
      <td style="padding: 10px;">Wonderkids Animation</td>
      <td style="padding: 10px;">Animation</td>
      <td style="padding: 10px;"><a href="https://www.voices.com/profile/shalomchidi-azuwike" target="_blank">View Sample</a></td>
    </tr>
    <tr style="border-bottom: 1px solid #30363d; background-color: #161b22;">
      <td style="padding: 10px;">Second Chances</td>
      <td style="padding: 10px;">Audiobooks</td>
      <td style="padding: 10px;"><a href="https://www.voices.com/profile/shalomchidi-azuwike" target="_blank">View Sample</a></td>
    </tr>
  </tbody>
...
<h2 align="center" style="color: #FF8C00;">🤝 Community Affiliations & Testimonials</h2>
...
<div style="background-color: #161b22; padding: 25px; border-radius: 8px;">
  <h3 align="center" style="border-bottom: 2px solid #FF8C00; padding-bottom: 10px;">What People Say About My Work</h3>
  
  <blockquote style="border-left: 4px solid #FF8C00; padding-left: 15px; margin: 30px 0;">
    <p style="font-style: italic; margin-bottom: 5px; font-size: 1.1em;">"Shalom delivered an exceptional website that exceeded our expectations. Her technical skills combined with creative design sense made our project a huge success. Highly recommended!"</p>
    <footer style="font-size: 0.9em; color: #aaa;">— Dr. Sarah Echefu, CEO, TechVision Solutions</footer>
  </blockquote>

  <blockquote style="border-left: 4px solid #FF8C00; padding-left: 15px; margin: 30px 0;">
    <p style="font-style: italic; margin-bottom: 5px; font-size: 1.1em;">"Working with Shalom to build a website for the church was the best experience ever and she built something remarkable."</p>
    <footer style="font-size: 0.9em; color: #aaa;">— Pastor Emeka Victor Samuel, Senior Pastor, Victory Life Global Outreach Ministries</footer>
  </blockquote>
  
  <blockquote style="border-left: 4px solid #FF8C00; padding-left: 15px; margin: 30px 0;">
    <p style="font-style: italic; margin-bottom: 5px; font-size: 1.1em;">"Shalom's mobile app development skills are outstanding. She built our business management app with incredible attention to detail and user experience. Couldn't be happier!"</p>
    <footer style="font-size: 0.9em; color: #aaa;">— Emmanuel Stanley, Director, Digital Dynamics</footer>
  </blockquote>
</div>
...
<div align="center" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 25px; margin-top: 30px;">
  
  <figure style="margin: 0;">
    <a href="https://unzep.netlify.app/" target="_blank">
      <img src="https://zeptaherself.netlify.app/un.png" alt="Screenshot of UN Website Revamp" width="100%" style="border-radius: 8px; border: 1px solid #FF8C00; box-shadow: 0 4px 10px rgba(255, 140, 0, 0.2);"/>
    </a>
    <figcaption style="font-size: 1.1em; font-weight: 600; margin-top: 10px; color: #FF8C00;">UN Website Revamp</figcaption>
    <p style="font-size: 0.9em; margin-top: 5px;">Modernized the United Nations website using React & FastAPI.</p>
  </figure>
  
  <figure style="margin: 0;">
    <a href="https://nkmedicals.netlify.app/" target="_blank">
      <img src="https://zeptaherself.netlify.app/ne/Screenshot%20(1720).png" alt="Screenshot of Lude Health Centre App" width="100%" style="border-radius: 8px; border: 1px solid #FF8C00; box-shadow: 0 4px 10px rgba(255, 140, 0, 0.2);"/>
    </a>
    <figcaption style="font-size: 1.1em; font-weight: 600; margin-top: 10px; color: #FF8C00;">Lude Health Centre App</figcaption>
    <p style="font-size: 0.9em; margin-top: 5px;">Hospital Management System built for an IEEE sponsored project.</p>
  </figure>

  <figure style="margin: 0;">
    <a href="https://zeptaherself.netlify.app/#projects" target="_blank">
      <img src="https://zeptaherself.netlify.app/janessaa.png" alt="Screenshot of Janessa AI Chatbot" width="100%" style="border-radius: 8px; border: 1px solid #FF8C00; box-shadow: 0 4px 10px rgba(255, 140, 0, 0.2);"/>
    </a>
    <figcaption style="font-size: 1.1em; font-weight: 600; margin-top: 10px; color: #FF8C00;">Janessa AI Chatbot</figcaption>
    <p style="font-size: 0.9em; margin-top: 5px;">AI-powered customer interaction chatbot using Python (Flask).</p>
  </figure>
  
  <figure style="margin: 0;">
    <a href="https://reigninglife.netlify.app/" target="_blank">
      <img src="https://zeptaherself.netlify.app/RLS.png" alt="Screenshot of Reigning Life School Website" width="100%" style="border-radius: 8px; border: 1px solid #FF8C00; box-shadow: 0 4px 10px rgba(255, 140, 0, 0.2);"/>
    </a>
    <figcaption style="font-size: 1.1em; font-weight: 600; margin-top: 10px; color: #FF8C00;">R.L. School Management</figcaption>
    <p style="font-size: 0.9em; margin-top: 5px;">Full-stack school management system with portals and authentication.</p>
  </figure>
</div>
